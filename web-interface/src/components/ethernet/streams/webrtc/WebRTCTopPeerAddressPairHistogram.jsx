...
export default function WebRTCTopPeerAddressPairHistogram({timeRange, filters, revision}) {
  ...
  useEffect(() => {
    ...
    webRTCService.getTopPeerAddressPairHistogram(
  ...
  return <ThreeColumnHistogram data={histogram}
                             columnTitles={["Address", "Address", "Bytes Exchanged"]}
