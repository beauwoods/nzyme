...
public class AddressPairNumberAggregationResultMapper implements RowMapper<AddressPairNumberAggregationResult> {

    @Override
    public AddressPairNumberAggregationResult map(ResultSet rs, StatementContext ctx) throws SQLException {
        ...
        return AddressPairNumberAggregationResult.create(
