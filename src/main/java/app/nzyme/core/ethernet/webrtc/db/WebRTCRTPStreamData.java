...
@AutoValue
public abstract class WebRTCRTPStreamData {
    ...
    @JsonCreator
    public static WebRTCRTPStreamData create(@JsonProperty("ssrc") long ssrc,
    ...
    public static Builder builder() {
        return new AutoValue_WebRTCRTPStreamData.Builder();
    }
    ...
    public abstract static class Builder {
        ...
        public abstract WebRTCRTPStreamData build();
    }
}
